    ...
    return rx.vstack(
        ...
        rx.vstack(
            ...
            link_button(
                "icons/github.svg",
                "CATQUIZ WEB",
                "Pagina web ejemplo modo Ecommerce para una tienda online de Joyas ",
                const.CATQUIZ_WEB_V2,
            ),
            link_button(
                "icons/github.svg",
        ...
        rx.vstack(
            ...
            link_button(
                "icons/platzi-svgrepo-com.svg",
                "CURSO DE REACT JS",
                "Platzi",
                const.REACT_JS_PLATZI,
            ),
            link_button(
                "icons/platzi-svgrepo-com.svg",
                "WEB COMPONENTS CON JAVASCRIPT",
                "Platzi",
                const.WEB_COMPONENTS_URL_PLATZI,
            ),
            link_button(
                "icons/platzi-svgrepo-com.svg",
                "CONSUMO DE API REST CON JAVASCRIPT",
                "Platzi",
                const.API_PRACTICO_URL_PLATZI,
            ),
            link_button(
                "icons/platzi-svgrepo-com.svg",
                "INTRODUCCION AL DESARROLLO BACKEND",
                "Platzi",
                const.INTRO_BACKEND_URL_PLATZI,
            ),
            link_button(
                "icons/platzi-svgrepo-com.svg",
                "JAVASCRIPT: MANIPULACIÓN DEL DOM",
                "Platzi",
                const.DOM_URL_PLATZI,
            ),
            link_button(
